...
while p<11
    ...
    xlabel('Propagaton constant B');            % X axis label
    ylabel('Angular frequemcy w');              % Y axis label
    xlim([-5000 5000]);                         % X limit
    ylim([0 3*10^12]);                          % Y limit
    p=p+1;                                      % Increasing p
end
legend('TE01','TE02','TE03','TE04','TE05','TE06','TE07','TE08','TE09','TE010');